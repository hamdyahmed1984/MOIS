...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190907020836_Initial')
BEGIN
...
BEGIN
    CREATE TABLE [Regulations] (
        ...
        CONSTRAINT [PK_Regulations] PRIMARY KEY ([DocumentTypeId], [JobTypeNIDId]),
        CONSTRAINT [FK_Regulations_DocumentType_DocumentTypeId] FOREIGN KEY ([DocumentTypeId]) REFERENCES [DocumentType] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_Regulations_JobTypeNID_JobTypeNIDId] FOREIGN KEY ([JobTypeNIDId]) REFERENCES [JobTypeNID] ([Id]) ON DELETE CASCADE
    );
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190907020836_Initial')
BEGIN
    CREATE INDEX [IX_Regulations_JobTypeNIDId] ON [Regulations] ([JobTypeNIDId]);
END;
...
BEGIN
    ...
    VALUES (N'20190907020836_Initial', N'2.2.6-servicing-10079');
END;
