...
{
    public class MarriageDocConfiguration : IEntityTypeConfiguration<MarriageDoc>
    {
        public void Configure(EntityTypeBuilder<MarriageDoc> builder)
        {
            builder.ToTable("MarriageDocs");
            ...
            builder.Property(p => p.SpouseFullName)
                .HasMaxLength(100)
                .IsRequired();
