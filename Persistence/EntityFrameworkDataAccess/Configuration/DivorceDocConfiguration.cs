...
{
    public class DivorceDocConfiguration : IEntityTypeConfiguration<DivorceDoc>
    {
        public void Configure(EntityTypeBuilder<DivorceDoc> builder)
        {
            builder.ToTable("DivorceDocs");
