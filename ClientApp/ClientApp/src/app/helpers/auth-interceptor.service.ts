...
export class AuthInterceptor implements HttpInterceptor {
  ...
  private refreshAccessToken(): Observable<any> {
    ...
    let token: string = this.helpers.getToken().RefreshToken;
...
//import { Injectable } from "@angular/core";
//import { HttpEvent, HttpHandler, HttpRequest, HttpSentEvent, HttpHeaderResponse, HttpProgressEvent, HttpResponse, HttpUserEvent, HttpErrorResponse } from "@angular/common/http";
...
//  constructor(private authService: AuthService, private helpers: Helpers, private config: AppConfig) {
//    //this._config = config;
//  }
...
//    return next.handle(this.addTokenToRequest(request, this.helpers.getToken().AccessToken))
//      .pipe(
//        catchError(err => {
...
//    return request.clone({ setHeaders: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ${token}' } });
//  }
...
//      return this.authService.RefreshToken(refreshTokenModel)
//        .pipe(
//          switchMap((accessTokenModel: AccessTokenModel) => {
//            if (accessTokenModel) {
//              this.tokenSubject.next(accessTokenModel.AccessToken);
//              this.helpers.setToken(accessTokenModel);
//              return next.handle(this.addTokenToRequest(request, accessTokenModel.AccessToken));
//            }
...
//  //    return this.httpClient.post(this._config.setting['apiUrl'] + 'api/token/refresh', refreshTokenModel).pipe(
//  //      switchMap((accessTokenModel: AccessTokenModel) => {
//  //        if (accessTokenModel) {
//  //          console.log('gone to server');
//  //          this.helpers.setToken(accessTokenModel);
//  //          req = req.clone({ setHeaders: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + accessTokenModel.AccessToken } });
...
//  //  else {
//  //    console.log('valid');
//  //    req = req.clone({ setHeaders: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + storedAccessToken.AccessToken } });
//  //  }
